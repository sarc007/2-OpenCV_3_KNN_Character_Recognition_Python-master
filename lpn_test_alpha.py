...
src_dir = "E:\\OPEN_1\\alphabets_resized"
dst_dir = "E:\\OPEN_1\\data"
model_dir = "E:\\OPEN_1\\model"
chk_pnt_dir = "E:\\OPEN_1\\training_all_nums\\cp.ckpt"
data_file = dst_dir + "\\" + "all_alpha.hdf5"   # please check this file before executing this script
...
model.save(model_dir + '\\alphabets.hdf5', overwrite=True)
new_model = tf.keras.models.load_model(model_dir + '\\alphabets.hdf5')
