...
def main():
	...
	new_model_weights = tf.keras.models.load_model(model_dir + '\\alphanumbers.hdf5')
	...
	for contourWithData in allContoursWithData:
		print('-------------------To Watch----------------------------------')
		print(contourWithData.innercontour,contourWithData.min_x,contourWithData.min_y,contourWithData.max_x,contourWithData.max_y)
		print('-----------------------------------------------------')
	print('To Watch')
	...
	for contourWithData in allContoursWithData:  # for all contours
		if contourWithData.checkIfContourIsValid():  # check if valid
			...
			print(contourWithData.innercontour, contourWithData.fltArea, contourWithData.intRectWidth, contourWithData.intRectHeight)
	...
	for contourWithData in validContoursWithData:  # for each contour
		...
		imgROI = recalibrate_width(imgROI, 7,16)
